...
def main():
  ...
  <div class="flex-1 min-w-0"><h3 class="text-lg font-semibold text-white group-hover:text-neon-cyan transition-colors" style="font-family:'Hanken Grotesk',sans-serif;">{lname}</h3></div>
...
<button class="w-full flex items-center justify-between px-6 py-5 hover:bg-surface-container-high transition-colors cursor-pointer" onclick="this.parentElement.classList.toggle('open')">
  <div class="flex items-center gap-4">
    ...
    <div class="text-left"><h2 class="text-3xl font-bold text-white mb-1" style="font-family:'Hanken Grotesk',sans-serif;">M{num}: {title_en if lang=="en" else title_ko}</h2><p class="text-on-surface-variant text-body-md">{title_ko if lang=="en" else title_en}</p></div>
  </div>
...
<button class="w-full flex items-center justify-between px-6 py-5 hover:bg-surface-container-high transition-colors cursor-pointer" onclick="this.parentElement.classList.toggle('open')">
  <div class="flex items-center gap-4">
    <span class="material-symbols-outlined text-neon-cyan transition-transform duration-200 module-chev">expand_more</span>
    <div class="text-left"><h2 class="text-3xl font-bold text-white mb-1" style="font-family:'Hanken Grotesk',sans-serif;">Study Guide</h2><p class="text-on-surface-variant text-body-md">Reference material</p></div>
  </div>
...
<button class="w-full flex items-center justify-between px-6 py-5 hover:bg-surface-container-high transition-colors cursor-pointer" onclick="this.parentElement.classList.toggle('open')">
  <div class="flex items-center gap-4">
    <span class="material-symbols-outlined text-neon-cyan transition-transform duration-200 module-chev">expand_more</span>
    <div class="text-left"><h2 class="text-3xl font-bold text-white mb-1" style="font-family:'Hanken Grotesk',sans-serif;">스터디 가이드</h2><p class="text-on-surface-variant text-body-md">참고 자료</p></div>
  </div>
  <div class="flex items-center gap-3"><span class="font-label-caps text-label-caps text-on-surface-variant bg-surface-container-high px-3 py-1 rounded-full">1 guide</span></div>
</button>
