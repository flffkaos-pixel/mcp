...
t.addEventListener('click',function(){{s(n==='ko'?'en':'ko')}});
s(n||'ko');
var totalLessons=document.querySelectorAll('.lesson').length/2;
document.getElementById('totalEn').textContent=totalLessons;
document.getElementById('totalKo').textContent=totalLessons;
document.getElementById('modsEn').textContent=document.querySelectorAll('.phase').length/2;
document.getElementById('modsKo').textContent=document.querySelectorAll('.phase').length/2;
